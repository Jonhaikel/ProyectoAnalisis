...
<body bgcolor="teal">
 <form id="form1" runat="server">
        ...
        <asp:TreeView ID="TreeView1" runat="server" Height="184px" ImageSet="Contacts" NodeIndent="10" Width="117px">
            ...
            <Nodes>
                <asp:TreeNode Target="ContenidoAJ" Text="Inicio" Value="Inicio" NavigateUrl="~/Administrador/Inicio.aspx"></asp:TreeNode>
<asp:TreeNode Target="Contenido" Text="Registrar" Value="Registrar" NavigateUrl="~/Administrador/Registrar.aspx"></asp:TreeNode>
                ...
                <asp:TreeNode NavigateUrl="~/Comprador/Configuraciones.aspx" Target="ContenidoAJ" Text="Configuracion" Value="Configuracion"></asp:TreeNode>
            </Nodes>
